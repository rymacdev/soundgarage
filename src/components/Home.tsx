  ...
  return (
    <div>
      ...
      <div className="my-6">
        ...
        <div className="grid gap-4 grid-rows-4 grid-cols-8">
          <div className="bg-slate-900 rounded-lg row-span-4 col-span-8 lg:row-span-4 lg:col-span-4 overflow-hidden relative">
            ...
            <div className="absolute bottom-3 left-4 sm:bottom-6 sm:left-6 text-white">
      ...
      <div className="my-6">
        ...
        <div className="grid gap-4 grid-rows-1 grid-cols-2 md:grid-cols-3 lg:grid-cols-6 text-slate-200">
          <div className="flex justify-center relative items-center col-span-1 row-span-1 bg-slate-700 rounded-md aspect-square hover:text-slate-300 overflow-hidden">
            <img src="/assets/images/banner-1200x600-04.jpg" className="w-full object-cover h-full opacity-70 hover:opacity-30" alt="banner" />
          ...
          <div className="flex justify-center relative items-center col-span-1 row-span-1 bg-slate-700 rounded-md aspect-square hover:text-slate-300 overflow-hidden">
            <img src="/assets/images/banner-1200x600-02.jpg" className="w-full object-cover h-full opacity-70 hover:opacity-30" alt="banner" />
            <div className="absolute flex flex-col justify-center">
              <FontAwesomeIcon icon={faCirclePlay} className="text-2xl mb-3"/>
            </div>
            <div className="absolute bottom-0 text-xs lg:text-sm bg-blue-800 w-full text-center p-2">Sala ba Diay</div>
          ...
          <div className="flex justify-center relative items-center col-span-1 row-span-1 bg-slate-700 rounded-md aspect-square hover:text-slate-300 overflow-hidden">
            <img src="/assets/images/banner-1200x600-03.jpg" className="w-full object-cover h-full opacity-70 hover:opacity-30" alt="banner" />
            <div className="absolute flex flex-col justify-center">
              <FontAwesomeIcon icon={faCirclePlay} className="text-2xl mb-3"/>
            </div>
            <div className="absolute bottom-0 text-xs lg:text-sm bg-blue-800 w-full text-center p-2">Sala ba Diay</div>
          ...
          <div className="flex justify-center relative items-center col-span-1 row-span-1 bg-slate-700 rounded-md aspect-square hover:text-slate-300 overflow-hidden">
            <img src="/assets/images/banner-1200x600-01.jpg" className="w-full object-cover h-full opacity-70 hover:opacity-30" alt="banner" />
            <div className="absolute flex flex-col justify-center">
              <FontAwesomeIcon icon={faCirclePlay} className="text-2xl mb-3"/>
            </div>
            <div className="absolute bottom-0 text-xs lg:text-sm bg-blue-800 w-full text-center p-2">Sala ba Diay</div>
